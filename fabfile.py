...
env.roledefs = {
    'web': [
        'savetheunicorns@scorch.devsoc.org',
        'savetheunicorns@smaug.devsoc.org',
    ],
    'demo': [
        'savetheunicorns@trogdor.devsoc.org',
    ],
    'cron': [
        'savetheunicorns@smaug.devsoc.org',
    ],
...
env.home = env.get('home', '/var/www/savetheunicorns')
env.virtualenv = env.get('virtualenv', '/var/envs/savetheunicorns')
env.appname = env.get('appname', 'savetheunicorns')
env.repo = env.get('repo', 'savetheunicorns')
env.media = env.get('media', 'savetheunicorns')
env.media_bucket = env.get('media_bucket', 'contentfiles-media-eu-west-1')
env.database = env.get('database', 'savetheunicorns_django')
